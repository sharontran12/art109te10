...
function init() {
  ...
  const loader = new GLTFLoader().load(
    "https://cdn.glitch.me/709fbd59-b70e-4b84-9d65-782e42544688%2Fworldglass.glb?v=1636882497081",
    function(gltf) {
  ...
  const loader2 = new GLTFLoader().load(
    "https://cdn.glitch.me/709fbd59-b70e-4b84-9d65-782e42544688%2Fcrystals.glb?v=1636882490028",
    function(gltf) {
...
function manualAnimation() {
  if (ticker == 0) {
    if (mesh2.scale.x < 2) {
      mesh2.scale.x += 0.06341;
    }
    if (mesh2.scale.x >= 2 && mesh2.scale.y < 2) {
      mesh2.scale.y += 0.05341;
    }
